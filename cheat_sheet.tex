...
$p(x|y)$ multivariate gaussian (w/ shared $\Sigma) \implies p(y|x)$ is logisitic function. The converse is NOT true. LDA makes stronger assumptions about data than does logistric regression.
